...
users_patterns = patterns('',
    ...
    url('^available$', views.available, name='users.available'),
    url('^friends$', views.friends, name='users.friends'),
# TODO:
...
#    url('^confirm/resend$', views.confirm_resend,
#        name='users.confirm.resend'),
